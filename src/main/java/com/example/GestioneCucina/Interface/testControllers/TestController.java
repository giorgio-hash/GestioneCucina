package com.example.GestioneCucina.Interface.testControllers;
...
import com.example.GestioneCucina.Domain.FrontSignalPort;
import com.example.GestioneCucina.Domain.TestPort;
...
public class TestController {
    ...
    @Autowired
    public TestController(TestService testService, Mapper<OrdineEntity, OrdineDTO> ordineMapper, FrontSignalPort frontSignalPort, String topic_notifyOrderEvent, String topic_notifyPrepEvent) {
        this.testService = testService;
        this.ordineMapper = ordineMapper;
        this.frontSignalPort = frontSignalPort;
        this.topic_notifyOrderEvent = topic_notifyOrderEvent;
        this.topic_notifyPrepEvent = topic_notifyPrepEvent;
    }
    ...
    public ResponseEntity<OrdineDTO> sendMessageToTopicSendOrderEvent(@RequestBody OrdineDTO ordineDTO) throws JsonProcessingException {
        ...
        OrdineEntity savedOrdineEntity = frontSignalPort.save(ordineEntity);
